//! Write-side of the manifest: `toml_edit`-based mutation of `agentpack.toml`.
//!
//! Every public method here loads the document, mutates it, and persists — preserving formatting
//! and comments via `toml_edit`. The read-side (types, `load`) lives in the parent module.
